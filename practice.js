...
let favoriteThings = {band: 'dunno', food: 'sushi', person: 'Justin', book: 'cant read', movie: 'depends on the day', holiday: 'christmas'};
...
function makePerson (name, birthday, ssn){
  let ob = {name: name, birthday: birthday, ssn: ssn}
  return ob
 }
